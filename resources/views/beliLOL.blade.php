...
@section('container')
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="left-image">
                <img src="assets/images/lollogo.png" alt="">
              </div>
            </div>
    ...
    <form method="POST" action="/LOLbeli" class="signin-form">
        @csrf
        @php
            $array = collect(['jenis_games' => ['id_jenis_game' => '4']]);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/images/riotPoint.png" alt="">
                              </div>
                              <div class="down-content">
                                  <h3>{{ $value->nama_paket }}</h3>
                                  <p>{{ $value->isi_paket }} Riot Point</p>
