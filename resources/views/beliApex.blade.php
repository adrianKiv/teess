...
@section('container')
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
              <h4>Apex Legends</h4>
              <span class="price">FPS, Battle Royale</span>
    ...
    <form method="POST" action="/Apexbeli" class="signin-form">
        @csrf
        @php
            $array = collect(['jenis_games' => ['id_jenis_game' => '5']]);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/images/syndicate.png" alt="">
                              </div>
                              <div class="down-content">
                                  <h3>{{ $value->nama_paket }}</h3>
                                  <p>{{ $value->isi_paket }} Syndicate Gold</p>
