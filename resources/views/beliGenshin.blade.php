...
@section('container')
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/genshinlogo1.png" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>Genshin Impact</h4>
          <span class="price">MMORPG</span>
  ...
  <form method="POST" action="/Genshinbeli" class="signin-form">
    @csrf
    @php
        $array = collect(['jenis_games' => ['id_jenis_game' => '7']]);
            ...
            <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-2 col-md-6 col-sm-6">
                      <div class="item">
                          <div class="thumb">
                              <img src="assets/images/genesis.png" alt="">
                            </div>
                            <div class="down-content">
                                <h3>{{ $value->nama_paket }}</h3>
                                <p>{{ $value->isi_paket }} Genesis Crystal</p>
