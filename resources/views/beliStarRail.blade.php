          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="left-image">
                <img src="assets/images/starraillogo1.png" alt="">
              </div>
            </div>
            <div class="col-lg-6 align-self-center">
              <h4>Honkai:Star Rail</h4>
              <span class="price">Strategy, role-playing</span>
              <p>Honkai: Star Rail is a role-playing gacha video game developed by miHoYo, published by miHoYo in China and by its subsidiary HoYoverse worldwide.</p>
            </div>
          </div>
        </div>
    </div>

    <form method="POST" action="/StarRailbeli" class="signin-form">
        @csrf
        @php
            $array = collect(['jenis_games' => ['id_jenis_game' => '6']]);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="item">
                            <div class="thumb">
                                <img src="assets/images/stellar.png" alt="">
                              </div>
                              <div class="down-content">
                                  <h3>{{ $value->nama_paket }}</h3>
                                  <p>{{ $value->isi_paket }} Stellar Jade</p>
