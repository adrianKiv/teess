...
@section('container')
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/valorantlogo1.png" alt="">
          </div>
        </div>
  ...
  <form method="POST" action="/Valobeli" class="signin-form">
    @csrf
    @php
        $array = collect(['jenis_games' => ['id_jenis_game' => '8']]);
